...
namespace BEPUutilities
{
    ...
    public struct Matrix3x2
    {
        ...
        /// <param name="b">Second matrix to multiply.</param>
        /// <param name="result">Product of the multiplication.</param>
        public static void Multiply(ref System.Numerics.Matrix4x4 a, ref Matrix3x2 b, out Matrix3x2 result)
        {
            float resultM11 = a.M11 * b.M11 + a.M12 * b.M21 + a.M13 * b.M31;
            float resultM12 = a.M11 * b.M12 + a.M12 * b.M22 + a.M13 * b.M32;
        ...
        public static void Transform(ref System.Numerics.Vector2 v, ref Matrix3x2 matrix, out System.Numerics.Vector3 result)
        {
#if !WINDOWS
