...
namespace BEPUutilities
{
    ...
    public struct Matrix2x2
    {
        ...
        /// <param name="b">Second matrix to add.</param>
        /// <param name="result">Sum of the two matrices.</param>
        public static void Add(ref System.Numerics.Matrix4x4 a, ref Matrix2x2 b, out Matrix2x2 result)
        {
            float m11 = a.M11 + b.M11;
            float m12 = a.M12 + b.M12;
        ...
        /// <param name="b">Second matrix to multiply.</param>
        /// <param name="result">Product of the multiplication.</param>
        public static void Multiply(ref Matrix2x2 a, ref System.Numerics.Matrix4x4 b, out Matrix2x2 result)
        {
            float resultM11 = a.M11 * b.M11 + a.M12 * b.M21;
            float resultM12 = a.M11 * b.M12 + a.M12 * b.M22;
