...
namespace BEPUutilities
{
    ...
    public struct BoundingBox
    {
        ...
        {
            System.Numerics.Vector3 clampedLocation;
        ...
        public static BoundingBox CreateFromPoints(IList<System.Numerics.Vector3> points)
        {
            BoundingBox aabb;
            if (points.Count == 0)
            ...
            {
                System.Numerics.Vector3 v = points[i];
                if (v.X < aabb.Min.X)
                    aabb.Min.X = v.X;
