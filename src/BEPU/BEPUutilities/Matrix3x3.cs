...
namespace BEPUutilities
{
    ...
    public struct Matrix3x3
    {
        ...
        /// </summary>
        public System.Numerics.Vector3 Backward
        {
            get
            {
#if !WINDOWS
        ...
        /// </summary>
        public System.Numerics.Vector3 Down
        {
            get
            {
#if !WINDOWS
        ...
        /// </summary>
        public System.Numerics.Vector3 Left
        {
            get
            {
#if !WINDOWS
        ...
        /// <param name="b">Second matrix to add.</param>
        /// <param name="result">Sum of the two matrices.</param>
        public static void Add(ref System.Numerics.Matrix4x4 a, ref Matrix3x3 b, out Matrix3x3 result)
        {
            float m11 = a.M11 + b.M11;
            float m12 = a.M12 + b.M12;
            float m13 = a.M13 + b.M13;
        ...
        /// <param name="b">Second matrix to add.</param>
        /// <param name="result">Sum of the two matrices.</param>
        public static void Add(ref Matrix3x3 a, ref System.Numerics.Matrix4x4 b, out Matrix3x3 result)
        {
            float m11 = a.M11 + b.M11;
            float m12 = a.M12 + b.M12;
            float m13 = a.M13 + b.M13;
        ...
        /// <param name="b">Second matrix to add.</param>
        /// <param name="result">Sum of the two matrices.</param>
        public static void Add(ref System.Numerics.Matrix4x4 a, ref System.Numerics.Matrix4x4 b, out Matrix3x3 result)
        {
            float m11 = a.M11 + b.M11;
            float m12 = a.M12 + b.M12;
            float m13 = a.M13 + b.M13;
        ...
        public static void CreateCrossProduct(ref System.Numerics.Vector3 v, out Matrix3x3 result)
        {
            result.M11 = 0;
            result.M12 = -v.Z;
            result.M13 = v.Y;
        ...
        /// </summary>
        /// <param name="matrix4X4">System.Numerics.Matrix4x4 to extract a 3x3 matrix from.</param>
        /// <param name="matrix3X3">Upper 3x3 matrix extracted from the XNA matrix.</param>
        public static void CreateFromMatrix(ref System.Numerics.Matrix4x4 matrix4X4, out Matrix3x3 matrix3X3)
        {
        ...
        public static Matrix3x3 CreateFromMatrix(System.Numerics.Matrix4x4 matrix4X4)
        {
            Matrix3x3 matrix3X3;
            matrix3X3.M11 = matrix4X4.M11;
            matrix3X3.M12 = matrix4X4.M12;
        ...
        /// <param name="matrix">Scaling matrix.</param>
        public static void CreateScale(ref System.Numerics.Vector3 scale, out Matrix3x3 matrix)
        {
        ...
        /// <param name="scale">Values defining the axis scales.</param>
        /// <returns>Scaling matrix.</returns>
        public static Matrix3x3 CreateScale(ref System.Numerics.Vector3 scale)
        {
        ...
        /// </summary>
        /// <param name="matrix">System.Numerics.Matrix4x4 to compute the adjugate transpose of.</param>
        ...
        /// <param name="b">Second matrix to multiply.</param>
        /// <param name="result">Product of the multiplication.</param>
        public static void Multiply(ref Matrix3x3 a, ref System.Numerics.Matrix4x4 b, out Matrix3x3 result)
        {
            float resultM11 = a.M11 * b.M11 + a.M12 * b.M21 + a.M13 * b.M31;
            float resultM12 = a.M11 * b.M12 + a.M12 * b.M22 + a.M13 * b.M32;
            float resultM13 = a.M11 * b.M13 + a.M12 * b.M23 + a.M13 * b.M33;
        ...
        /// <param name="b">Second matrix to multiply.</param>
        /// <param name="result">Product of the multiplication.</param>
        public static void Multiply(ref System.Numerics.Matrix4x4 a, ref Matrix3x3 b, out Matrix3x3 result)
        {
            float resultM11 = a.M11 * b.M11 + a.M12 * b.M21 + a.M13 * b.M31;
            float resultM12 = a.M11 * b.M12 + a.M12 * b.M22 + a.M13 * b.M32;
            float resultM13 = a.M11 * b.M13 + a.M12 * b.M23 + a.M13 * b.M33;
        ...
        /// </summary>
        /// <param name="matrix">System.Numerics.Matrix4x4 to be multiplied.</param>
        /// <param name="transpose">System.Numerics.Matrix4x4 to be transposed and multiplied.</param>
        /// <param name="result">Product of the multiplication.</param>
        ...
        /// </summary>
        /// <param name="v">System.Numerics.Vector3 to transform.</param>
        /// <param name="matrix">System.Numerics.Matrix4x4 to use as the transformation.</param>
        /// <param name="result">Product of the transformation.</param>
        public static void Transform(ref System.Numerics.Vector3 v, ref Matrix3x3 matrix, out System.Numerics.Vector3 result)
        {
            float vX = v.X;
            float vY = v.Y;
            float vZ = v.Z;
        ...
        public static System.Numerics.Vector3 Transform(System.Numerics.Vector3 v, Matrix3x3 matrix)
        {
        ...
        /// </summary>
        /// <param name="v">System.Numerics.Vector3 to transform.</param>
        /// <param name="matrix">System.Numerics.Matrix4x4 to use as the transformation transpose.</param>
        /// <param name="result">Product of the transformation.</param>
        public static void TransformTranspose(ref System.Numerics.Vector3 v, ref Matrix3x3 matrix, out System.Numerics.Vector3 result)
        {
            float vX = v.X;
            float vY = v.Y;
            float vZ = v.Z;
        ...
        /// <param name="matrix">System.Numerics.Matrix4x4 to use as the transformation transpose.</param>
        /// <returns>Product of the transformation.</returns>
        public static System.Numerics.Vector3 TransformTranspose(System.Numerics.Vector3 v, Matrix3x3 matrix)
        {
            float vX = v.X;
            float vY = v.Y;
            float vZ = v.Z;
        ...
        /// <param name="matrix">System.Numerics.Matrix4x4 to transpose.</param>
        /// <param name="result">Transposed matrix.</param>
        public static void Transpose(ref System.Numerics.Matrix4x4 matrix, out Matrix3x3 result)
        {
            float m21 = matrix.M12;
            float m31 = matrix.M13;
            float m12 = matrix.M21;
        ...
        /// </summary>
        /// <param name="quaternion">System.Numerics.Quaternion to use to create a matrix.</param>
        /// <param name="result">System.Numerics.Matrix4x4 representing the quaternion's orientation.</param>
        public static void CreateFromQuaternion(ref System.Numerics.Quaternion quaternion, out Matrix3x3 result)
        {
        ...
        /// </summary>
        /// <param name="quaternion">System.Numerics.Quaternion to use to create a matrix.</param>
        /// <returns>System.Numerics.Matrix4x4 representing the quaternion's orientation.</returns>
        public static Matrix3x3 CreateFromQuaternion(System.Numerics.Quaternion quaternion)
        {
            Matrix3x3 result;
        ...
        public static void CreateOuterProduct(ref System.Numerics.Vector3 a, ref System.Numerics.Vector3 b, out Matrix3x3 result)
        {
            result.M11 = a.X * b.X;
            result.M12 = a.X * b.Y;
            result.M13 = a.X * b.Z;
        ...
        /// <returns>System.Numerics.Matrix4x4 representing the rotation.</returns>
        public static Matrix3x3 CreateFromAxisAngle(System.Numerics.Vector3 axis, float angle)
        {
            Matrix3x3 toReturn;
        ...
        /// <param name="axis">Axis around which to rotate.</param>
        /// <param name="angle">Amount to rotate.</param>
        /// <param name="result">System.Numerics.Matrix4x4 representing the rotation.</param>
        public static void CreateFromAxisAngle(ref System.Numerics.Vector3 axis, float angle, out Matrix3x3 result)
        {
