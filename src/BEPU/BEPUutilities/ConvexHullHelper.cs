...
namespace BEPUutilities
{
    ...
    public static partial class ConvexHullHelper
    {
        ...
        public static void GetConvexHull(IList<System.Numerics.Vector3> points, IList<int> outputTriangleIndices)
        {
        ...
        public static void GetConvexHull(IList<System.Numerics.Vector3> points, IList<System.Numerics.Vector3> outputSurfacePoints)
        {
            var rawPoints = CommonResources.GetVectorList();
            rawPoints.AddRange(points);
        ...
        /// <param name="points">List of points in the set.</param>
        /// <param name="outputSurfacePoints">Unique points on the surface of the convex hull.</param>
        public static void GetConvexHull(RawList<System.Numerics.Vector3> points, IList<System.Numerics.Vector3> outputSurfacePoints)
        {
        ...
        /// Each group of 3 indices represents a triangle on the surface of the hull.</param>
        /// <param name="outputSurfacePoints">Unique points on the surface of the convex hull.</param>
        public static void GetConvexHull(IList<System.Numerics.Vector3> points, IList<int> outputTriangleIndices, IList<System.Numerics.Vector3> outputSurfacePoints)
        {
            var rawPoints = CommonResources.GetVectorList();
            var rawIndices = CommonResources.GetIntList();
            rawPoints.AddRange(points);
        ...
        /// Each group of 3 indices represents a triangle on the surface of the hull.</param>
        /// <param name="outputSurfacePoints">Unique points on the surface of the convex hull.</param>
        public static void GetConvexHull(RawList<System.Numerics.Vector3> points, RawList<int> outputTriangleIndices, IList<System.Numerics.Vector3> outputSurfacePoints)
        {
        ...
        /// <param name="outputTriangleIndices">List of indices into the input point set composing the triangulated surface of the convex hull.
        /// Each group of 3 indices represents a triangle on the surface of the hull.</param>
        public static void GetConvexHull(RawList<System.Numerics.Vector3> points, RawList<int> outputTriangleIndices)
        {
            if (points.Count == 0)
            {
            ...
            while (outsidePoints.Count > 0)
            {
                ...
                for (int k = 0; k < outputTriangleIndices.Count; k += 3)
                {
                    ...
                    System.Numerics.Vector3 maximum = points.Elements[maxIndex];
        ...
        private static int GetExtremePoint(ref System.Numerics.Vector3 direction, RawList<System.Numerics.Vector3> points, RawList<int> outsidePoints)
        {
        ...
        private static void GetExtremePoints(ref System.Numerics.Vector3 direction, RawList<System.Numerics.Vector3> points, out float maximumDot, out float minimumDot, out int maximumIndex, out int minimumIndex)
        {
            maximumIndex = 0;
            minimumIndex = 0;
        ...
        private static void ComputeInitialTetrahedron(RawList<System.Numerics.Vector3> points, RawList<int> outsidePointCandidates, RawList<int> triangleIndices, out System.Numerics.Vector3 centroid)
        {
        ...
        private static void RemoveInsidePoints(RawList<System.Numerics.Vector3> points, RawList<int> triangleIndices, RawList<int> outsidePoints)
        {
            ...
            for (int i = 0; i < triangleIndices.Count && insidePoints.Count > 0; i += 3)
            {
                ...
                System.Numerics.Vector3 p = points.Elements[triangleIndices.Elements[i]];
        ...
        private static void FindNormal(RawList<int> indices, RawList<System.Numerics.Vector3> points, int triangleIndex, out System.Numerics.Vector3 normal)
        {
        ...
        private static bool IsTriangleVisibleFromPoint(RawList<int> indices, RawList<System.Numerics.Vector3> points, int triangleIndex, ref System.Numerics.Vector3 point)
        {
        ...
        private static void VerifyWindings(RawList<int> newIndices, RawList<System.Numerics.Vector3> points, ref System.Numerics.Vector3 centroid)
        {
