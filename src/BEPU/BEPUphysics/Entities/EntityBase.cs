...
namespace BEPUphysics.Entities
{
    ...
    {
        internal System.Numerics.Vector3 position;
        internal System.Numerics.Quaternion orientation = System.Numerics.Quaternion.Identity;
...
#if CONSERVE
        internal System.Numerics.Vector3 angularMomentum;
#endif
        ...
        /// </summary>
        public System.Numerics.Vector3 AngularMomentum
        {
            get
            {
#if CONSERVE
        ...
        /// </summary>
        public System.Numerics.Vector3 LinearMomentum
        {
            get
            {
                System.Numerics.Vector3 momentum;
        ...
        public void ApplyImpulse(System.Numerics.Vector3 location, System.Numerics.Vector3 impulse)
        {
        ...
        ///<param name="location">Location to apply the impulse.</param>
        ///<param name="impulse">Impulse to apply.</param>
        public void ApplyImpulse(ref System.Numerics.Vector3 location, ref System.Numerics.Vector3 impulse)
        {
            if (isDynamic)
            {
                ApplyLinearImpulse(ref impulse);
#if WINDOWS
                System.Numerics.Vector3 positionDifference;
#else
                System.Numerics.Vector3 positionDifference = new System.Numerics.Vector3();
#endif
        ...
        /// </summary>
        /// <param name="impulse">Impulse to apply.</param>
        public void ApplyLinearImpulse(ref System.Numerics.Vector3 impulse)
        {
        ...
        /// </summary>
        /// <param name="impulse">Impulse to apply.</param>
        public void ApplyAngularImpulse(ref System.Numerics.Vector3 impulse)
        {
