...
namespace BEPUphysics.Entities.Prefabs
{
    ...
    public class Cylinder : Entity<ConvexCollidable<CylinderShape>>
    {
        ...
        public Cylinder(System.Numerics.Vector3 position, float height, float radius, float mass)
        ...
        /// <param name="height">Height of the cylinder.</param>
        /// <param name="radius">Radius of the cylinder.</param>
        public Cylinder(System.Numerics.Vector3 position, float height, float radius)
            : this(height, radius)
        {
            Position = position;
        }
