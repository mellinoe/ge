...
namespace BEPUphysics.Entities.Prefabs
{
    ...
    public class WrappedBody : Entity<ConvexCollidable<WrappedShape>>
    {
        ...
        public WrappedBody(System.Numerics.Vector3 position, IList<ConvexShapeEntry> subBodies, float mass)
            : this(subBodies, mass)
        {
            Position = position;
        }
        ...
        /// <param name="position">Position of the box.</param>
        /// <param name="subBodies">List of entities composing the body.</param>
        public WrappedBody(System.Numerics.Vector3 position, IList<ConvexShapeEntry> subBodies)
            : this(subBodies)
        {
            Position = position;
        }
