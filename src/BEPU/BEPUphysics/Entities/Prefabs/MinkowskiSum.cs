...
namespace BEPUphysics.Entities.Prefabs
{
    ...
    public class MinkowskiSum : Entity<ConvexCollidable<MinkowskiSumShape>>
    {
        ...
        public MinkowskiSum(System.Numerics.Vector3 position, OrientedConvexShapeEntry a, OrientedConvexShapeEntry b, float mass)
            : this(a, b, mass)
        {
            Position = position;
        }
        ...
        /// <param name="a">First entity in the sum.</param>
        /// <param name="b">Second entity in the sum.</param>
        public MinkowskiSum(System.Numerics.Vector3 position, OrientedConvexShapeEntry a, OrientedConvexShapeEntry b)
            : this(a, b)
        {
            Position = position;
        }
