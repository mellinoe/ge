...
namespace BEPUphysics.Entities.Prefabs
{
    ...
    public class Cone : Entity<ConvexCollidable<ConeShape>>
    {
        ...
        public Cone(System.Numerics.Vector3 position, float height, float radius, float mass)
        ...
        /// <param name="height">Height of the cone.</param>
        /// <param name="radius">Radius of the cone.</param>
        public Cone(System.Numerics.Vector3 position, float height, float radius)
            : this(height, radius)
        {
            Position = position;
        }
