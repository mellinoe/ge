...
namespace BEPUphysics.BroadPhaseEntries
{
    ...
    public class StaticGroup : StaticCollidable
    {
        ...
        /// <param name="hit">Hit data, if any.</param>
        /// <returns>Whether or not the cast hit anything.</returns>
        public override bool ConvexCast(ConvexShape castShape, ref RigidTransform startingTransform, ref System.Numerics.Vector3 sweep, Func<BroadPhaseEntry, bool> filter, out RayHit hit)
        {
            RayCastResult result;
