...
namespace BEPUphysics.BroadPhaseEntries
{
    ...
    public class StaticMesh : StaticCollidable
    {
        ...
        public StaticMesh(System.Numerics.Vector3[] vertices, int[] indices)
        {
        ...
        public StaticMesh(System.Numerics.Vector3[] vertices, int[] indices, AffineTransform worldTransform)
        {
