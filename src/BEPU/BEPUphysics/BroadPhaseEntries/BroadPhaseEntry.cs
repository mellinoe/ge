...
namespace BEPUphysics.BroadPhaseEntries
{
    ...
    public abstract class BroadPhaseEntry : IBoundingBoxOwner, ICollisionRulesOwner
    {
        ...
        public abstract bool ConvexCast(ConvexShape castShape, ref RigidTransform startingTransform, ref System.Numerics.Vector3 sweep, out RayHit hit);
        ...
        /// <param name="hit">Hit data of the cast on the entry, if any.</param>
        /// <returns>Whether or not the cast hit the entry.</returns>
        public virtual bool ConvexCast(ConvexShape castShape, ref RigidTransform startingTransform, ref System.Numerics.Vector3 sweep, Func<BroadPhaseEntry, bool> filter, out RayHit hit)
        {
            if (filter(this))
