...
namespace BEPUphysics.DataStructures
{
    ...
    public class TransformableMeshData : MeshBoundingBoxTreeData
    {
        ...
        public TransformableMeshData(System.Numerics.Vector3[] vertices, int[] indices)
        {
            Vertices = vertices;
            Indices = indices;
        }
        ...
        public override void GetTriangle(int triangleIndex, out System.Numerics.Vector3 v1, out System.Numerics.Vector3 v2, out System.Numerics.Vector3 v3)
        {
        ...
        public override void GetVertexPosition(int i, out System.Numerics.Vector3 vertex)
        {
