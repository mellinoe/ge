...
namespace BEPUphysics.CollisionShapes.ConvexShapes
{
    ...
    public class BoxShape : ConvexShape
    {
        ...
        {
            extremePoint = new System.Numerics.Vector3(Math.Sign(direction.X) * (halfWidth - collisionMargin), Math.Sign(direction.Y) * (halfHeight - collisionMargin), Math.Sign(direction.Z) * (halfLength - collisionMargin));
        }
