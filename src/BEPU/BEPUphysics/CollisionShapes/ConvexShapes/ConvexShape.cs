...
namespace BEPUphysics.CollisionShapes.ConvexShapes
{
    ...
    public abstract class ConvexShape : EntityShape
    {
        ...
        public abstract void GetLocalExtremePointWithoutMargin(ref System.Numerics.Vector3 direction, out System.Numerics.Vector3 extremePoint);
        ...
        public void GetSweptBoundingBox(ref RigidTransform transform, ref System.Numerics.Vector3 sweep, out BoundingBox boundingBox)
        {
        ...
        public void GetLocalBoundingBox(ref RigidTransform shapeTransform, ref AffineTransform spaceTransform, out BoundingBox boundingBox)
        {
            ...
            System.Numerics.Vector3 right;
            var direction = new System.Numerics.Vector3(transform.LinearTransform.M11, transform.LinearTransform.M21, transform.LinearTransform.M31);
            GetLocalExtremePoint(direction, out right);

            System.Numerics.Vector3 left;
            direction = new System.Numerics.Vector3(-transform.LinearTransform.M11, -transform.LinearTransform.M21, -transform.LinearTransform.M31);
            GetLocalExtremePoint(direction, out left);

            System.Numerics.Vector3 up;
            direction = new System.Numerics.Vector3(transform.LinearTransform.M12, transform.LinearTransform.M22, transform.LinearTransform.M32);
            ...
            System.Numerics.Vector3 backward;
            direction = new System.Numerics.Vector3(transform.LinearTransform.M13, transform.LinearTransform.M23, transform.LinearTransform.M33);
