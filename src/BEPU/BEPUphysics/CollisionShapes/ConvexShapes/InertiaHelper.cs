...
namespace BEPUphysics.CollisionShapes.ConvexShapes
{
    ...
    public static class InertiaHelper
    {
        ...
        public static void GetPointContribution(float pointWeight, ref System.Numerics.Vector3 center, ref System.Numerics.Vector3 point, out Matrix3x3 contribution)
        {
        ...
        /// </summary>
        public static System.Numerics.Vector3[] SampleDirections;
        ...
        public static void ComputeShapeDistribution(IList<System.Numerics.Vector3> vertices, IList<int> triangleIndices, out float volume, out Matrix3x3 volumeDistribution)
        {
        ...
        /// <param name="volume">Volume of the shape.</param>
        /// <param name="volumeDistribution">Distribution of the volume as measured from the computed center.</param>
        public static void ComputeShapeDistribution(IList<System.Numerics.Vector3> vertices, IList<int> triangleIndices, out System.Numerics.Vector3 center, out float volume, out Matrix3x3 volumeDistribution)
        {
            //Explanation for the tetrahedral integration bits: Explicit Exact Formulas for the 3-D Tetrahedron Inertia Tensor in Terms of its Vertex Coordinates
            //http://www.scipub.org/fulltext/jms2/jms2118-11.pdf
            //x1, x2, x3, x4 are origin, triangle1, triangle2, triangle3
            ...
            System.Numerics.Vector3 summedCenter = new System.Numerics.Vector3();
            float scaledVolume = 0;
            for (int i = 0; i < triangleIndices.Count; i += 3)
            {
                System.Numerics.Vector3 v2 = vertices[triangleIndices[i]];
                ...
                System.Numerics.Vector3 tetrahedronCentroid;
