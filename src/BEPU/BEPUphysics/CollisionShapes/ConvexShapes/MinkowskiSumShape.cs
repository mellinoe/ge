...
namespace BEPUphysics.CollisionShapes.ConvexShapes
{
    ...
    public class MinkowskiSumShape : ConvexShape
    {
        ...
        public MinkowskiSumShape(OrientedConvexShapeEntry firstShape, OrientedConvexShapeEntry secondShape, out System.Numerics.Vector3 center)
        ...
        /// <param name="shapeEntries">Entries composing the minkowski sum.</param>
        /// <param name="center">Center of the minkowski sum computed pre-recentering.</param>
        public MinkowskiSumShape(IList<OrientedConvexShapeEntry> shapeEntries, out System.Numerics.Vector3 center)
            : this(shapeEntries)
        {
            center = -localOffset;
        }
        ...
        public MinkowskiSumShape(IList<OrientedConvexShapeEntry> shapeEntries, System.Numerics.Vector3 localOffset, ConvexShapeDescription description)
        {
            for (int i = 0; i < shapeEntries.Count; i++)
            {
                shapes.Add(shapeEntries[i]);
