...
namespace BEPUphysics.CollisionShapes.ConvexShapes
{
    ...
    public class ConvexHullShape : ConvexShape
    {
        ...
        public ReadOnlyList<System.Numerics.Vector3> Vertices
        {
            get
            {
                return new ReadOnlyList<System.Numerics.Vector3>(vertices);
            }
        }
        ...
        public ConvexHullShape(IList<System.Numerics.Vector3> vertices)
        {
            if (vertices.Count == 0)
        ...
        ///<exception cref="ArgumentException">Thrown when the point set is empty.</exception>
        public ConvexHullShape(IList<System.Numerics.Vector3> vertices, out System.Numerics.Vector3 center)
        {
            if (vertices.Count == 0)
                throw new ArgumentException("Vertices list used to create a ConvexHullShape cannot be empty.");
        ...
        ///<exception cref="ArgumentException">Thrown when the point set is empty.</exception>
        public ConvexHullShape(IList<System.Numerics.Vector3> vertices, out System.Numerics.Vector3 center, IList<int> outputHullTriangleIndices, IList<System.Numerics.Vector3> outputUniqueSurfaceVertices)
        {
            if (vertices.Count == 0)
                throw new ArgumentException("Vertices list used to create a ConvexHullShape cannot be empty.");
            ...
            this.vertices = new System.Numerics.Vector3[outputUniqueSurfaceVertices.Count];
        ...
        public ConvexHullShape(IList<System.Numerics.Vector3> localSurfaceVertices, ConvexShapeDescription description)
        {
            ...
            vertices = new System.Numerics.Vector3[localSurfaceVertices.Count];
        ...
        public static ConvexShapeDescription ComputeDescription(IList<System.Numerics.Vector3> vertices, float collisionMargin, out System.Numerics.Vector3 center, IList<int> outputHullTriangleIndices, IList<System.Numerics.Vector3> outputUniqueSurfaceVertices)
        {
        ...
        public static float ComputeMaximumRadius(IList<System.Numerics.Vector3> localSurfaceVertices, float collisionMargin)
        {
        ...
        public override void GetBoundingBox(ref RigidTransform shapeTransform, out BoundingBox boundingBox)
        {
            ...
            float minY, maxY;
            float minZ, maxZ;
            var right = new System.Numerics.Vector3(o.M11, o.M21, o.M31);
            var up = new System.Numerics.Vector3(o.M12, o.M22, o.M32);
            var backward = new System.Numerics.Vector3(o.M13, o.M23, o.M33);
