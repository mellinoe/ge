    ...
    public class CylinderShape : ConvexShape
    {
        ...
        public override void GetLocalExtremePointWithoutMargin(ref System.Numerics.Vector3 direction, out System.Numerics.Vector3 extremePoint)
        {
            ...
            if (horizontalLengthSquared > Toolbox.Epsilon)
            {
                ...
                extremePoint = new System.Numerics.Vector3(direction.X * multiplier, Math.Sign(direction.Y) * (halfHeight - collisionMargin), direction.Z * multiplier);
            }
            else
            {
                extremePoint = new System.Numerics.Vector3(0, Math.Sign(direction.Y) * (halfHeight - collisionMargin), 0);
            }
