...
namespace BEPUphysics.CollisionShapes
{
    ...
    public class MobileMeshShape : EntityShape
    {
        ...
        RawList<System.Numerics.Vector3> hullVertices = new RawList<System.Numerics.Vector3>();

        /// <summary>
        /// Gets the list of vertices on the convex hull of the mesh used to compute the bounding box.
        /// </summary>
        public ReadOnlyList<System.Numerics.Vector3> HullVertices
        {
            get { return new ReadOnlyList<System.Numerics.Vector3>(hullVertices); }
        }
        ...
        public MobileMeshShape(System.Numerics.Vector3[] vertices, int[] indices, AffineTransform localTransform, MobileMeshSolidity solidity, out System.Numerics.Vector3 center)
        {
            this.solidity = solidity;
            var data = new TransformableMeshData(vertices, indices, localTransform);
            var shapeDistributionInformation = ComputeVolumeDistribution(data);
        ...
        public MobileMeshShape(TransformableMeshData meshData, IList<System.Numerics.Vector3> hullVertices, MobileMeshSolidity solidity, TriangleSidedness sidednessWhenSolid, float collisionMargin, EntityShapeVolumeDescription volumeDescription)
        {
            triangleMesh = new TriangleMesh(meshData);
            this.hullVertices = new RawList<System.Numerics.Vector3>(hullVertices);
        ...
        TriangleSidedness ComputeSolidSidednessHelper(Ray ray)
        {
            ...
            if (triangleMesh.Tree.GetOverlaps(ray, hitList))
            {
                ...
                if (hits.Count % 2 == 0)
                {
                    ...
                    var normal = System.Numerics.Vector3.Cross(vA - vB, vA - vC);
        ...
        private void UpdateSurfaceVertices()
        {
            ...
            else
            {
                ...
                hullVertices.Add(new System.Numerics.Vector3(box.Min.X, box.Min.Y, box.Max.Z));
                hullVertices.Add(new System.Numerics.Vector3(box.Min.X, box.Max.Y, box.Min.Z));
                hullVertices.Add(new System.Numerics.Vector3(box.Max.X, box.Min.Y, box.Min.Z));
                hullVertices.Add(new System.Numerics.Vector3(box.Min.X, box.Max.Y, box.Max.Z));
                hullVertices.Add(new System.Numerics.Vector3(box.Max.X, box.Max.Y, box.Min.Z));
                hullVertices.Add(new System.Numerics.Vector3(box.Max.X, box.Min.Y, box.Max.Z));
            }
        }
        ...
        private ShapeDistributionInformation ComputeVolumeDistribution(TransformableMeshData data)
        {
            ...
            shapeInformation.Center = new System.Numerics.Vector3();
        ...
        /// <param name="boundingBox">Bounding box in the local space.</param>
        public void GetSweptLocalBoundingBox(ref RigidTransform shapeTransform, ref AffineTransform spaceTransform, ref System.Numerics.Vector3 sweep, out BoundingBox boundingBox)
        {
            GetLocalBoundingBox(ref shapeTransform, ref spaceTransform, out boundingBox);
            System.Numerics.Vector3 expansion;
