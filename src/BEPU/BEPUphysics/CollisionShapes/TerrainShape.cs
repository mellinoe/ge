...
namespace BEPUphysics.CollisionShapes
{
    ...
    public class TerrainShape : CollisionShape
    {
        ...
        public void GetLocalPosition(int columnIndex, int rowIndex, out System.Numerics.Vector3 v)
        {
#if !WINDOWS
        ...
        public void GetLocalNormal(int columnIndex, int rowIndex, out System.Numerics.Vector3 normal)
        {
            ...
            //Since the horizontal offsets are known to be 1 in local space, we can omit quite a few operations compared to a full System.Numerics.Vector3 and cross product.

            //The implicit vectors are:
            //var leftToRight = new System.Numerics.Vector3(2, rightHeight - leftHeight, 0);
            //var bottomToTop = new System.Numerics.Vector3(0, topHeight - bottomHeight, 2);
            //the result is then:
        ...
        public void GetFirstTriangle(int columnIndex, int rowIndex, ref AffineTransform transform, out System.Numerics.Vector3 a, out System.Numerics.Vector3 b, out System.Numerics.Vector3 c)
        {
            if (quadTriangleOrganization == QuadTriangleOrganization.BottomLeftUpperRight)
            {
