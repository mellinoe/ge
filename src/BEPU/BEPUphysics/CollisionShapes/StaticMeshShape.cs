...
namespace BEPUphysics.CollisionShapes
{
    ...
    public class StaticMeshShape : CollisionShape
    {
        ...
        public StaticMeshShape(System.Numerics.Vector3[] vertices, int[] indices, AffineTransform worldTransform)
        {
        ...
        ///<param name="vertices">Vertices of the mesh.</param>
        ///<param name="indices">Indices of the mesh.</param>
        public StaticMeshShape(System.Numerics.Vector3[] vertices, int[] indices)
        {
