    ...
    public class BufferedStatesAccessor
    {
        ...
        public Matrix3x3 OrientationMatrix
        {
            get
            {
                ...
                if (IsReadBufferAccessible())
                {
                    System.Numerics.Quaternion o = bufferedStates.BufferedStatesManager.ReadBuffers.GetState(bufferedStates.motionStateIndex).Orientation;
            ...
            set
            {
                if (IsWriteBufferAccessible())
                {
                    System.Numerics.Quaternion toSet = QuaternionEx.Normalize(QuaternionEx.CreateFromRotationMatrix(value));
        ...
        public System.Numerics.Matrix4x4 WorldTransform
        {
            ...
            set
            {
                if (IsWriteBufferAccessible())
                {
                    System.Numerics.Vector3 translation = value.Translation;
