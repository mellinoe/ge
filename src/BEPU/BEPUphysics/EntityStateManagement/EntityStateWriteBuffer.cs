...
namespace BEPUphysics.EntityStateManagement
{
    ...
    public class EntityStateWriteBuffer : ProcessingStage
    {
        ...
        {
            [FieldOffset(0)]
            internal System.Numerics.Quaternion orientationQuaternion;
            [FieldOffset(0)]
            internal System.Numerics.Vector3 vector;
            [FieldOffset(16)]
        ...
        public void EnqueueOrientation(Entity entity, ref System.Numerics.Quaternion newOrientationQuaternion)
        {
        ...
        public void EnqueueAngularVelocity(Entity entity, ref System.Numerics.Vector3 newAngularVelocity)
        {
