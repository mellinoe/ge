...
namespace BEPUphysics.Character
{
    ...
    public class SphereCharacterController : Updateable, IBeforeSolverUpdateable
    {
        ...
        private System.Numerics.Vector3 down = new System.Numerics.Vector3(0, -1, 0);
        /// <summary>
        ...
        System.Numerics.Vector3 viewDirection = new System.Numerics.Vector3(0, 0, -1);
        ...
        void ExpandBoundingBox()
        {
            if (Body.ActivityInformation.IsActive)
            {
                ...
                System.Numerics.Vector3 expansion = SupportFinder.MaximumAssistedDownStepHeight * down;
        ...
        void ComputeRelativeVelocity(ref SupportData supportData, out System.Numerics.Vector3 relativeVelocity)
        {
            ...
            if (SupportFinder.HasSupport)
            {
                ...
                if (entityCollidable != null)
                {
                    ...
                    System.Numerics.Vector3 entityVelocity;
                    bool locked;
        ...
        public override void OnAdditionToSpace(Space newSpace)
        {
            ...
            Body.AngularVelocity = new System.Numerics.Vector3();
            Body.LinearVelocity = new System.Numerics.Vector3();
        }
