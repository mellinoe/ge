...
namespace BEPUphysics.Character
{
    ...
    public class StepManager
    {
        ...
        public bool TryToStepDown(out System.Numerics.Vector3 newPosition)
        {
            ...
            System.Numerics.Vector3 normal = SupportFinder.SupportRayData.Value.HitData.Normal;
        ...
        public bool TryToStepUp(out System.Numerics.Vector3 newPosition)
        {
        ...
        void FindUpStepCandidates(RawList<ContactData> outputStepCandidates, ref System.Numerics.Vector3 down)
        {
            System.Numerics.Vector3 movementDirection = HorizontalMotionConstraint.MovementDirection3d;
            foreach (var c in SupportFinder.SideContacts)
            {
        ...
        private void PrepareQueryObject(ref System.Numerics.Vector3 position)
        {
        ...
        CharacterContactPositionState TryUpStepPosition(ref System.Numerics.Vector3 sideNormal, ref System.Numerics.Vector3 position, ref System.Numerics.Vector3 down,
            ref QuickList<CharacterContact> tractionContacts, ref QuickList<CharacterContact> supportContacts, ref QuickList<CharacterContact> sideContacts, ref QuickList<CharacterContact> headContacts,
            out float hintOffset)
        {
            hintOffset = 0;
        ...
        bool IsUpStepObstructedBySideContacts(ref System.Numerics.Vector3 sideNormal, ref QuickList<CharacterContact> sideContacts)
        {
            //A contact is considered obstructive if its projected depth is deeper than any existing contact along the existing contacts' normals.
            for (int i = 0; i < sideContacts.Count; i++)
            {
