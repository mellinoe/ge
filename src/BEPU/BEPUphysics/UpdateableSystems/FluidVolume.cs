...
namespace BEPUphysics.UpdateableSystems
{
    ...
    public class FluidVolume : Updateable, IDuringForcesUpdateable, ICollisionRulesOwner
    {
        ...
        System.Numerics.Vector3 upVector;
        ///<summary>
        ...
        private System.Numerics.Vector3 flowDirection;
        /// <summary>
        ...
        /// </summary>
        public System.Numerics.Vector3 FlowDirection
        {
            get
            {
            ...
            set
            {
                ...
                if (length > 0)
                {
                    ...
                    flowDirection = System.Numerics.Vector3.Zero;
        ...
        private List<System.Numerics.Vector3[]> surfaceTriangles;
        /// <summary>
        /// List of coplanar triangles composing the surface of the fluid.
        /// </summary>
        public List<System.Numerics.Vector3[]> SurfaceTriangles
        {
            get
            {
        ...
        /// <param name="surfaceTriangles">List of triangles composing the surface of the fluid.  Set up as a list of length 3 arrays of System.Numerics.Vector3's.</param>
        ...
        public FluidVolume(System.Numerics.Vector3 upVector, float gravity, List<System.Numerics.Vector3[]> surfaceTriangles, float depth, float fluidDensity, float linearDamping, float angularDamping)
        {
            Gravity = gravity;
