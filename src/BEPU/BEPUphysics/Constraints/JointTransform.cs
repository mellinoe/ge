...
namespace BEPUphysics.Constraints
{
    ...
    {
        internal System.Numerics.Vector3 localPrimaryAxis = Vector3Ex.Backward;
        internal System.Numerics.Vector3 localXAxis = Vector3Ex.Right;
        internal System.Numerics.Vector3 localYAxis = Vector3Ex.Up;
        internal System.Numerics.Vector3 primaryAxis = Vector3Ex.Backward;
        internal Matrix3x3 rotationMatrix = Matrix3x3.Identity;
        internal System.Numerics.Vector3 xAxis = Vector3Ex.Right;
        internal System.Numerics.Vector3 yAxis = Vector3Ex.Up;

        /// <summary>
        /// Gets the primary axis of the transform in local space.
        /// </summary>
        public System.Numerics.Vector3 LocalPrimaryAxis
        {
        ...
        /// </summary>
        public System.Numerics.Vector3 LocalXAxis
        {
        ...
        /// </summary>
        public System.Numerics.Vector3 LocalYAxis
        {
        ...
        /// </summary>
        public System.Numerics.Vector3 PrimaryAxis
        {
        ...
        /// <param name="rotationMatrix">System.Numerics.Matrix4x4 to use to transform the local axes into world space.</param>
        public void SetLocalAxes(System.Numerics.Vector3 primaryAxis, System.Numerics.Vector3 xAxis, System.Numerics.Vector3 yAxis, Matrix3x3 rotationMatrix)
        {
        ...
        /// <param name="xAxis">Second axis in the transform.</param>
        /// <param name="yAxis">Third axis in the transform.</param>
        public void SetLocalAxes(System.Numerics.Vector3 primaryAxis, System.Numerics.Vector3 xAxis, System.Numerics.Vector3 yAxis)
        {
            ...
            localPrimaryAxis = System.Numerics.Vector3.Normalize(primaryAxis);
            localXAxis = System.Numerics.Vector3.Normalize(xAxis);
            localYAxis = System.Numerics.Vector3.Normalize(yAxis);
            ComputeWorldSpaceAxes();
        }
        ...
        public void SetLocalAxes(Matrix3x3 matrix)
        {
            ...
            localYAxis = System.Numerics.Vector3.Normalize(matrix.Up);
            ComputeWorldSpaceAxes();
        }
        ...
        /// <param name="yAxis">Third axis in the transform.</param>
        /// <param name="rotationMatrix">System.Numerics.Matrix4x4 to use to transform the local axes into world space.</param>
        public void SetWorldAxes(System.Numerics.Vector3 primaryAxis, System.Numerics.Vector3 xAxis, System.Numerics.Vector3 yAxis, Matrix3x3 rotationMatrix)
        {
            this.rotationMatrix = rotationMatrix;
        ...
        /// <param name="xAxis">Second axis in the transform.</param>
        /// <param name="yAxis">Third axis in the transform.</param>
        public void SetWorldAxes(System.Numerics.Vector3 primaryAxis, System.Numerics.Vector3 xAxis, System.Numerics.Vector3 yAxis)
        {
            if (Math.Abs(Vector3Ex.Dot(primaryAxis, xAxis)) > Toolbox.BigEpsilon ||
                Math.Abs(Vector3Ex.Dot(primaryAxis, yAxis)) > Toolbox.BigEpsilon ||
                Math.Abs(Vector3Ex.Dot(xAxis, yAxis)) > Toolbox.BigEpsilon)
            ...
            this.primaryAxis = System.Numerics.Vector3.Normalize(primaryAxis);
            this.xAxis = System.Numerics.Vector3.Normalize(xAxis);
            this.yAxis = System.Numerics.Vector3.Normalize(yAxis);
        ...
        public void SetWorldAxes(Matrix3x3 matrix)
        {
            ...
            primaryAxis = System.Numerics.Vector3.Normalize(matrix.Backward);
            xAxis = System.Numerics.Vector3.Normalize(matrix.Right);
            yAxis = System.Numerics.Vector3.Normalize(matrix.Up);
            Matrix3x3.TransformTranspose(ref this.primaryAxis, ref rotationMatrix, out localPrimaryAxis);
            Matrix3x3.TransformTranspose(ref this.xAxis, ref rotationMatrix, out localXAxis);
            Matrix3x3.TransformTranspose(ref this.yAxis, ref rotationMatrix, out localYAxis);
        }
    ...
    public class JointBasis2D
    {
        ...
        /// <param name="xAxis">Second axis in the transform.</param>
        /// <param name="rotationMatrix">System.Numerics.Matrix4x4 to use to transform the local axes into world space.</param>
        public void SetLocalAxes(System.Numerics.Vector3 primaryAxis, System.Numerics.Vector3 xAxis, Matrix3x3 rotationMatrix)
        {
            this.rotationMatrix = rotationMatrix;
        ...
        /// <param name="primaryAxis">First axis in the transform.  Usually aligned along the main axis of a joint, like the twist axis of a TwistLimit.</param>
        /// <param name="xAxis">Second axis in the transform.</param>
        public void SetLocalAxes(System.Numerics.Vector3 primaryAxis, System.Numerics.Vector3 xAxis)
        {
            if (Math.Abs(Vector3Ex.Dot(primaryAxis, xAxis)) > Toolbox.BigEpsilon)
        ...
        /// <param name="xAxis">Second axis in the transform.</param>
        /// <param name="rotationMatrix">System.Numerics.Matrix4x4 to use to transform the local axes into world space.</param>
        public void SetWorldAxes(System.Numerics.Vector3 primaryAxis, System.Numerics.Vector3 xAxis, Matrix3x3 rotationMatrix)
        {
            this.rotationMatrix = rotationMatrix;
        ...
        /// <param name="primaryAxis">First axis in the transform.  Usually aligned along the main axis of a joint, like the twist axis of a TwistLimit.</param>
        /// <param name="xAxis">Second axis in the transform.</param>
        public void SetWorldAxes(System.Numerics.Vector3 primaryAxis, System.Numerics.Vector3 xAxis)
        {
            if (Math.Abs(Vector3Ex.Dot(primaryAxis, xAxis)) > Toolbox.BigEpsilon)
                throw new ArgumentException("The axes provided to the joint transform are not perpendicular.  Ensure that the specified axes form a valid constraint.");
            this.primaryAxis = System.Numerics.Vector3.Normalize(primaryAxis);
