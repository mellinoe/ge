...
namespace BEPUphysics.Constraints.TwoEntity.JointLimits
{
    ...
    public class TwistLimit : JointLimit, I1DImpulseConstraintWithError, I1DJacobianConstraint
    {
        ...
        public TwistLimit(Entity connectionA, Entity connectionB, System.Numerics.Vector3 axisA, System.Numerics.Vector3 axisB, float minimumAngle, float maximumAngle)
        {
