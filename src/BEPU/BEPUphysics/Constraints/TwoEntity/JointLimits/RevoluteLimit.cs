...
namespace BEPUphysics.Constraints.TwoEntity.JointLimits
{
    ...
    public class RevoluteLimit : JointLimit, I2DImpulseConstraintWithError, I2DJacobianConstraint
    {
        ...
        private System.Numerics.Vector3 jacobianMaxA;
        private System.Numerics.Vector3 jacobianMaxB;
        private System.Numerics.Vector3 jacobianMinA;
        private System.Numerics.Vector3 jacobianMinB;
        private bool maxIsActive;
        private bool minIsActive;
        private System.Numerics.Vector2 error;
        private System.Numerics.Vector3 localTestAxis;
        ...
        private System.Numerics.Vector3 worldTestAxis;
        private System.Numerics.Vector2 velocityToImpulse;
        ...
        public RevoluteLimit(Entity connectionA, Entity connectionB, System.Numerics.Vector3 limitedAxis, System.Numerics.Vector3 testAxis, float minimumAngle, float maximumAngle)
        {
        ...
        /// </summary>
        public System.Numerics.Vector3 LocalTestAxis
        {
            get { return localTestAxis; }
            set
            {
                localTestAxis = System.Numerics.Vector3.Normalize(value);
        ...
        /// </summary>
        public System.Numerics.Vector3 TestAxis
        {
            get { return worldTestAxis; }
            set
            {
                worldTestAxis = System.Numerics.Vector3.Normalize(value);
        ...
        public System.Numerics.Vector2 RelativeVelocity
        {
            get
            {
                if (isLimitActive)
                {
                    ...
                    System.Numerics.Vector2 toReturn = System.Numerics.Vector2.Zero;
                    if (minIsActive)
                    {
