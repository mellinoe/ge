...
namespace BEPUphysics.Constraints.Collision
{
    ...
    public class TwistFrictionConstraint : SolverUpdateable
    {
...
#else
            System.Numerics.Vector3 angular;
#endif
        ...
        public override void Update(float dt)
        {
            ...
            System.Numerics.Vector3 relativeSlidingVelocity = contactManifoldConstraint.SlidingFriction.relativeVelocity;
            ...
            System.Numerics.Vector3 contactOffset;
            for (int i = 0; i < contactCount; i++)
            {
