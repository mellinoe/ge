...
namespace BEPUphysics.Vehicle
{
    ...
    public abstract class WheelShape : ICollisionRulesOwner
    {
        ...
        /// </summary>
        protected internal Box detector = new Box(System.Numerics.Vector3.Zero, 0, 0, 0);

        protected internal System.Numerics.Matrix4x4 localGraphicTransform;
        ...
        internal System.Numerics.Matrix4x4 steeringTransform;
        protected internal Wheel wheel;

        protected internal System.Numerics.Matrix4x4 worldTransform;
        ...
        /// </summary>
        public System.Numerics.Matrix4x4 LocalGraphicTransform
        {
        ...
        protected internal abstract bool FindSupport(out System.Numerics.Vector3 location, out System.Numerics.Vector3 normal, out float suspensionLength, out Collidable supportCollidable, out Entity entity, out Material material);
