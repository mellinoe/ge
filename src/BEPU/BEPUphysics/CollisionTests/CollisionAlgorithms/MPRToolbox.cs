...
namespace BEPUphysics.CollisionTests.CollisionAlgorithms
{
    ...
    public static class MPRToolbox
    {
        ...
        public static bool GetOverlapPosition(ConvexShape shapeA, ConvexShape shapeB, ref RigidTransform transformA, ref RigidTransform transformB, out System.Numerics.Vector3 position)
        {
        ...
        /// <returns>Whether or not the two shapes overlap.</returns>
        public static bool GetLocalOverlapPosition(ConvexShape shapeA, ConvexShape shapeB, ref RigidTransform localTransformB, out System.Numerics.Vector3 position)
        {
        ...
        public static void LocalSurfaceCast(ConvexShape shapeA, ConvexShape shapeB, ref RigidTransform localTransformB, ref System.Numerics.Vector3 direction, out float t, out System.Numerics.Vector3 normal)
        {
        ...
        static bool VerifySimplex(ref System.Numerics.Vector3 v0, ref System.Numerics.Vector3 v1, ref System.Numerics.Vector3 v2, ref System.Numerics.Vector3 v3, ref System.Numerics.Vector3 direction)
        {


            //v1, v0, v3
            System.Numerics.Vector3 cross = System.Numerics.Vector3.Cross(v0 - v1, v3 - v1);
            float planeProduct1 = Vector3Ex.Dot(cross, direction);
            //v3, v0, v2
            cross = System.Numerics.Vector3.Cross(v0 - v3, v2 - v3);
            float planeProduct2 = Vector3Ex.Dot(cross, direction);
            //v2, v0, v1
            cross = System.Numerics.Vector3.Cross(v0 - v2, v1 - v2);
        ...
        public static void RefinePenetration(ConvexShape shapeA, ConvexShape shapeB, ref RigidTransform localTransformB, float initialDepth, ref System.Numerics.Vector3 initialNormal, out float penetrationDepth, out System.Numerics.Vector3 refinedNormal, out System.Numerics.Vector3 position)
        {
            //The local casting can optionally continue.  Eventually, it will converge to the local minimum.
        ...
        public static bool Sweep(ConvexShape shapeA, ConvexShape shapeB, ref System.Numerics.Vector3 sweepA, ref System.Numerics.Vector3 sweepB, ref RigidTransform transformA, ref RigidTransform transformB, out RayHit hit)
        {
            ...
            if (!AreSweptShapesIntersecting(shapeA, shapeB, ref sweep, ref localTransformB, out hit.Location)) //Computes a hit location to be used if the early-outs due to being in contact.
            {
                ...
                hit.Location = new System.Numerics.Vector3();
                return false;
            }
            if (negativeLength)
            {
            ...
            if (LocalSweepCast(shapeA, shapeB, sweepLength, rayLengthSquared, ref localDirection, ref sweep, ref localTransformB, out hit))
            {
                ...
                System.Numerics.Vector3 minkowskiRayHit = -hit.T * localDirection;
        ...
        private static bool LocalSweepCast(ConvexShape shape, ConvexShape shapeB, float sweepLength, float rayLengthSquared, ref System.Numerics.Vector3 localDirection, ref System.Numerics.Vector3 sweep, ref RigidTransform localTransformB, out RayHit hit)
        {
            ...
            //This implementation is similar to that of the original XenoCollide.
            //'n' will be the direction used to find supports throughout the algorithm.
            System.Numerics.Vector3 n = localDirection;
            System.Numerics.Vector3 v1, v1A;
            ...
            //{
            //    hit.T = 0;
            //    System.Numerics.Vector3.Normalize(ref n, out hit.Normal);
            //    System.Numerics.Vector3.Transform(ref hit.Normal, ref transform.Orientation, out hit.Normal);
            //    //hit.Location = hit.T * localDirection;
            //    System.Numerics.Vector3.Transform(ref hit.Location, ref transform.Orientation, out hit.Location);
            ...
            while (true)
            {
                ...
                if (supportDot - dot < rayCastSurfaceEpsilon || count > MPRToolbox.InnerIterationLimit) // TODO: Could use a dynamic epsilon for possibly better behavior.
                {
                    ...
                    //System.Numerics.Vector3 mdHitLocation = t * localDirection;
                    //float v1Weight, v2Weight, v3Weight;
        ...
        internal static void GetLocalPosition(ConvexShape shapeA, ConvexShape shapeB, ref RigidTransform localTransformB, ref System.Numerics.Vector3 minkowskiPosition, out System.Numerics.Vector3 position)
        {
            ...
            //This implementation is similar to that of the original XenoCollide.
            //'n' will be the direction used to find supports throughout the algorithm.
            System.Numerics.Vector3 n = rayDirection;
            System.Numerics.Vector3 v1;
            System.Numerics.Vector3 v1A, v1B; //extreme point contributions from each shape.  Used later to compute contact position; could be used to cache simplex too.
            MinkowskiToolbox.GetLocalMinkowskiExtremePoint(shapeA, shapeB, ref n, ref localTransformB, out v1A, out v1B, out v1);
            ...
            System.Numerics.Vector3 temp;
            System.Numerics.Vector3 v0v1, v0v2;
            //Set n for the first iteration.
            ...
            System.Numerics.Vector3 pointToV0;
            ...
            while (true)
            {
                //Test the origin against the plane defined by v1, v2, v3.  If it's inside, we're done.
                //Compute the outward facing normal.
                System.Numerics.Vector3 v2v3, v2v1;
                ...
                float dot;
                System.Numerics.Vector3 pointToV1;
                ...
                //If the origin is further along the direction than the extreme point, it's not inside the shape.
                float dot2;
                System.Numerics.Vector3 pointToV4;
                ...
                {
                    System.Numerics.Vector3 pointToV2;
                ...
                {
                    System.Numerics.Vector3 pointToV3;
        ...
        public static bool AreSweptShapesIntersecting(ConvexShape shapeA, ConvexShape shapeB, ref System.Numerics.Vector3 sweep, ref RigidTransform localTransformB, out System.Numerics.Vector3 position)
        {
            //It's possible that the two objects' centers are overlapping, or very very close to it.  In this case, 
            //they are obviously colliding and we can immediately exit.
            ...
            //This implementation is similar to that of the original XenoCollide.
            //'n' will be the direction used to find supports throughout the algorithm.
            System.Numerics.Vector3 n = localTransformB.Position;
            System.Numerics.Vector3 v1;
            System.Numerics.Vector3 v1A; //extreme point contributions from each shape.  Used later to compute contact position; could be used to cache simplex too.
            ...
            System.Numerics.Vector3 v3A, v3;
            int count = 0;
            while (true)
            {
                //Find a final extreme point using the normal of the plane defined by v0, v1, v2.
        ...
        static void GetSweptExtremePoint(ConvexShape shapeA, ConvexShape shapeB, ref RigidTransform localTransformB, ref System.Numerics.Vector3 sweep, ref System.Numerics.Vector3 extremePointDirection, out System.Numerics.Vector3 extremePointA, out System.Numerics.Vector3 extremePoint)
        {
        ...
        public static bool SweptShapeContainsPoint(ConvexShape shape, ref System.Numerics.Vector3 sweep, ref System.Numerics.Vector3 localPoint)
        {
            //It's possible that the two objects' centers are overlapping, or very very close to it.  In this case, 
            //they are obviously colliding and we can immediately exit.
            ...
            //This implementation is similar to that of the original XenoCollide.
            //'n' will be the direction used to find supports throughout the algorithm.
            System.Numerics.Vector3 n = localPoint;
            System.Numerics.Vector3 v1;
            //MinkowskiToolbox.GetLocalMinkowskiExtremePoint(shape, shapeB, ref n, ref localPoint, out v1A, out v1B, out v1);
        ...
        private static bool LocalSweepCast(ConvexShape shape, float sweepLength, float rayLengthSquared, ref System.Numerics.Vector3 localDirection, ref System.Numerics.Vector3 sweep, ref System.Numerics.Vector3 rayOrigin, out RayHit hit)
        {
            //By now, the ray is known to be within the swept shape and facing the right direction for a normal raycast.
        ...
        static void GetSweptExtremePoint(ConvexShape shape, ref System.Numerics.Vector3 point, ref System.Numerics.Vector3 sweep, ref System.Numerics.Vector3 extremePointDirection, out System.Numerics.Vector3 extremePoint)
        {
