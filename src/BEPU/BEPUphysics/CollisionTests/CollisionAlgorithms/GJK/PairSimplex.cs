...
namespace BEPUphysics.CollisionTests.CollisionAlgorithms.GJK
{
    ...
    public struct CachedSimplex
    {
        ...
        //    System.Numerics.Vector3.Transform(ref direction, ref conjugate, out direction);
    ...
    public struct ContributingShapeSimplex
    {
        ...
        public System.Numerics.Vector3 D;
    }
    ...
    public struct PairSimplex
    {
        ...
        private PairSimplex(ref RigidTransform localTransformB)
        {
            ...
            B = new System.Numerics.Vector3();
            C = new System.Numerics.Vector3();
            D = new System.Numerics.Vector3();
            U = 0;
            V = 0;
            W = 0;
        }
        ...
        public bool GetPointClosestToOrigin(out System.Numerics.Vector3 point)
        {
        ...
        public bool GetPointOnTetrahedronClosestToOrigin(out System.Numerics.Vector3 point)
        {
            ...
            point = new System.Numerics.Vector3();
            float minimumDistance = float.MaxValue;


            PairSimplex candidate;
            float candidateDistance;
            System.Numerics.Vector3 candidatePoint;
        ...
        private static bool TryTetrahedronTriangle(ref System.Numerics.Vector3 A, ref System.Numerics.Vector3 B, ref System.Numerics.Vector3 C,
                                                   ref System.Numerics.Vector3 A1, ref System.Numerics.Vector3 B1, ref System.Numerics.Vector3 C1,
                                                   ref System.Numerics.Vector3 A2, ref System.Numerics.Vector3 B2, ref System.Numerics.Vector3 C2,
                                                   float errorTolerance,
                                                   ref System.Numerics.Vector3 otherPoint, out PairSimplex simplex, out System.Numerics.Vector3 point)
        {
        ...
        public void GetClosestPoints(out System.Numerics.Vector3 closestPointA, out System.Numerics.Vector3 closestPointB)
        {
            //A * U + B * V + C * W
            switch (State)
            {
