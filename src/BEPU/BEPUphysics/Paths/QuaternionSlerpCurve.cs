...
namespace BEPUphysics.Paths
{
    ...
    /// </summary>
    public class QuaternionSlerpCurve : Curve<System.Numerics.Quaternion>
    {
        /// <summary>
        ...
        public override void Evaluate(int controlPointIndex, float weight, out System.Numerics.Quaternion value)
        {
        ...
        protected internal override void ControlPointAdded(CurveControlPoint<System.Numerics.Quaternion> curveControlPoint, int index)
        {
        }
        ...
        protected internal override void ControlPointRemoved(CurveControlPoint<System.Numerics.Quaternion> curveControlPoint, int oldIndex)
        {
        }
        ...
        protected internal override void ControlPointTimeChanged(CurveControlPoint<System.Numerics.Quaternion> curveControlPoint, int oldIndex, int newIndex)
        {
        }
        ...
        /// </summary>
        /// <param name="curveControlPoint">Changed control point.</param>
        protected internal override void ControlPointValueChanged(CurveControlPoint<System.Numerics.Quaternion> curveControlPoint)
        {
        }
    }
}