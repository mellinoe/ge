...
namespace BEPUphysics.Paths
{
    ...
    public class VariableLinearSpeedCurve : VariableSpeedCurve<System.Numerics.Vector3>
    {
        /// <summary>
        ...
        public VariableLinearSpeedCurve(Path<float> speedCurve, Curve<System.Numerics.Vector3> curve)
        ...
        public VariableLinearSpeedCurve(Path<float> speedCurve, Curve<System.Numerics.Vector3> curve, int sampleCount)
