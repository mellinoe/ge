...
namespace BEPUphysics.Paths
{
    ...
    /// </summary>
    public abstract class HermiteCurve3D : Curve<System.Numerics.Vector3>
    {
        /// <summary>
        /// Internal list of curve tangents.
        /// </summary>
        protected List<System.Numerics.Vector3> tangents = new List<System.Numerics.Vector3>();


        /// <summary>
        /// Gets the tangents used by the curve per control point.
        /// </summary>
        public ReadOnlyList<System.Numerics.Vector3> Tangents
        {
            get
            {
                return new ReadOnlyList<System.Numerics.Vector3>(tangents);
            }
        }
        ...
        protected internal override void ControlPointAdded(CurveControlPoint<System.Numerics.Vector3> curveControlPoint, int index)
        {
            tangents.Clear();
            ComputeTangents();
        }
        ...
        protected internal override void ControlPointRemoved(CurveControlPoint<System.Numerics.Vector3> curveControlPoint, int oldIndex)
        {
            tangents.Clear();
            ComputeTangents();
        }
        ...
        protected internal override void ControlPointTimeChanged(CurveControlPoint<System.Numerics.Vector3> curveControlPoint, int oldIndex, int newIndex)
        {
            tangents.Clear();
            ComputeTangents();
        }
        ...
        /// </summary>
        /// <param name="curveControlPoint">Changed control point.</param>
        protected internal override void ControlPointValueChanged(CurveControlPoint<System.Numerics.Vector3> curveControlPoint)
        {
            tangents.Clear();
            ComputeTangents();
        }
