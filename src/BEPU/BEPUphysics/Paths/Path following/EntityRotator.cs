...
namespace BEPUphysics.Paths.PathFollowing
{
    ...
    public class EntityRotator : Updateable, IDuringForcesUpdateable
    {
        ...
        /// </summary>
        public System.Numerics.Quaternion TargetOrientation { get; set; }
        ...
        public static System.Numerics.Vector3 GetAngularVelocity(System.Numerics.Quaternion start, System.Numerics.Quaternion end, float dt)
        {
