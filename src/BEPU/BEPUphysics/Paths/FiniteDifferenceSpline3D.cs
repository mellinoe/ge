...
namespace BEPUphysics.Paths
{
    ...
    public class FiniteDifferenceSpline3D : HermiteCurve3D
    {
        ...
        protected override void ComputeTangents()
        {
            ...
            {
                tangents.Add(System.Numerics.Vector3.Zero);
                return;
            }
            if (ControlPoints.Count == 2)
            {
                System.Numerics.Vector3 tangent = ControlPoints[1].Value - ControlPoints[0].Value;
                tangents.Add(tangent);
                tangents.Add(tangent);
                return;
            }

            System.Numerics.Vector3 tangentA, tangentB;
            System.Numerics.Vector3 previous, current, next;
            //First endpoint
